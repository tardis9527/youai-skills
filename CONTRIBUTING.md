...
4. 同步创建 `platforms/windsurf/workflows/`、`platforms/cursor/skills/{skill-name}/SKILL.md`、`platforms/claude-code/skills/{skill-name}/SKILL.md` 和 `platforms/codex/skills/{skill-name}/SKILL.md` 下的适配版本
