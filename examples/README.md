...
本目录包含部分 Skill 的产出样例，帮助你直观理解 Skill 的输出效果。

现有示例基于同一个虚构产品 **TeamLog（团队日报助手）** 编写，用于展示部分 Skill 之间的上下游串联关系。

| 文件 | 对应 Skill | 说明 |
|------|-----------|------|
| [example-project-analysis.md](./example-project-analysis.md) | 01_项目理解与分析 | 项目理解报告（节选） |
...
| [example-uiux-redesign.md](./example-uiux-redesign.md) | 05_UI/UX设计风格重塑 | UI/UX 设计重塑方案（节选） |
| [example-investor-bp-generation.md](./example-investor-bp-generation.md) | 06_投资人BP商业计划报告生成 | BP 报告节选 + 500字口述版 |
